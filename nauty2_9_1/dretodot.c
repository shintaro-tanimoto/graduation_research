 ...
 *                                                                     *
 * gcc -O3 -o dretodot dretodot.c nauty.a                              *
 * nauty.a is produced by: make all                                    *
 *                                                                     *
 *   CHANGE HISTORY                                                    *
 * 03-Aug-2023 - bug fixed (color field size)                          */
...
main(int argc, char *argv[])
{
    ...
    rswitch = dswitch = mswitch = nswitch = oswitch = iswitch = xswitch
    = Sswitch = gswitch = fswitch = vswitch = rswitch1 = Vswitch
    = Eswitch = FALSE;
    ...
    while (fscanf(infile, "%1s", s) == 1)
    {
                 ...
                 || s[0] == ';')
        {
            ...
            gt_abort_1(">E dretodot: invalid command \"%c\"\n", s[0]);
    }
